public class NumArrayList implements NumList{
    ...
    //method that removes duplicates of any eleents in the list
    ...
    public static void main(String[] args) {
        NumArrayList testList = new NumArrayList(); 
        testList.add(9);
        testList.add(2);
        testList.add(19);
        testList.add(4.3);
        ...
        testList.add(5);
        testList.add(3.6);
        System.out.println("List of ADDED elements (printed using toString): " + testList.toString());
        System.out.println();
        ...
        System.out.println("List: " + testList.toString());
        System.out.println("SIZE (printed using method): " + testList.size() );
        System.out.println("CAPACITY (printed using method): " + testList.capacity() );
        System.out.println();

        System.out.println("Check if current list CONTAINS value 3.6");
        System.out.println("Result: " + testList.contains(3.6));
        System.out.println("Check if current list CONTAINS value 19.0");
        System.out.println("Result: " + testList.contains(19.0));
        System.out.println();
        ...
        compareList.add(5.0);
        System.out.println("Compare if testList is EQUAL to identical compareList");
        System.out.println("Result: " + testList.equals(compareList));
        compareList.remove(4);
        compareList.add(17.0);
        System.out.println("Compare if testList is EQUAL to nonidentical compareList");
        System.out.println("Result: " + testList.equals(compareList));
        System.out.println();

        testList.lookup(2);
        System.out.println("LOOKUP value at index 3");
        System.out.println("Value @ Index 3: " + testList.lookup(3));
        System.out.println("LOOKUP value at index 10 (last element of array)");
        System.out.println("Value @ Index 4: " + testList.lookup(4));
        System.out.println("LOOKUP value at index 10 (beyond array size)");
        try {
			testList.lookup(10); //lookup element at index 0 for empty list
